...
export const siteConfig = {
  ...
  aboutMe:
    "I'm a software developer with a Master's in Applied Artificial Intelligence and a Bachelor's in Digital Games Development Engineering, specializing in gameplay systems and game AI. At WaveFunctionVR, I built VR training applications, a drone flight simulator in Unreal Engine 4, and reusable libraries that cut project setup time by over 50%. My personal projects focus on gameplay systems and game AI - state machines, behaviour trees, pathfinding - across both Unity and Unreal Engine, applying design patterns and decoupled, data-driven architecture to keep systems reusable and easy to expand. I've also taught game engine fundamentals and OOP to first-year students as an invited assistant professor. Outside of games, I've worked as a software developer at Deloitte, debugging and maintaining production database systems. Even though games are my specialty, they've given me the knowledge to architect clean code and scalable systems that translate directly into broader software engineering challenges.",
